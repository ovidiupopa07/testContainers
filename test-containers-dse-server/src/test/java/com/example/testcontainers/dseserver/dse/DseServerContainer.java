package com.example.testcontainers.dseserver.dse;
...
public class DseServerContainer<SELF extends DseServerContainer<SELF>> extends GenericContainer<SELF> {

    private static final String IMAGE = "datastax/dse-server";
